...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v.equals(b1)) {
            if(b1.getText().toString().equals("Mode: Adddition"))
                b1.setText("Mode: Subtraction");
            else if(b1.getText().toString().equals("Mode: Subtraction"))
                b1.setText("Mode: Multiplication");
            else if(b1.getText().toString().equals("Mode: Multiplication"))
                b1.setText("Mode: Division");
            else if(b1.getText().toString().equals("Mode: Division"))
                b1.setText("Mode: Addition");
        }
            ...
            if(b1.getText().toString().equals("Mode: Addition"))
